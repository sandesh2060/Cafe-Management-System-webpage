// ============================================
// FILE: frontend/src/auth/pages/StaffLoginPage.jsx
// 🎯 UNIFIED STAFF LOGIN
// ✅ For Admin, Manager, Waiter, Cashier, Cook
// ============================================
...
const StaffLoginPage = () => {
  ...
  const [formData, setFormData] = useState({
    email: '',
    password: '',
    role: '' // Optional - can help backend identify staff vs customer
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If successful, useAuth automatically navigates
    } catch (err) {
